...
class Movimientos(models.Model):
    FechaMovimiento = models.CharField('Fecha del movimiento', max_length = 100, default='')
    Productos = models.ForeignKey(Productos, on_delete=models.CASCADE, default='', null=True)
    CantidadProductos = models.PositiveIntegerField('Cantidad de productos')
    Clientes = models.ForeignKey(Clientes, on_delete=models.CASCADE, default='', blank=True, null=True)
    Proveedores = models.ForeignKey(Proveedores, on_delete=models.CASCADE, default='', null=True, blank=True)
...
class Inventario(models.Model):
    ...
    TotalInventario = models.CharField('Cantidad de productos en inventario', default='', max_length=100)
