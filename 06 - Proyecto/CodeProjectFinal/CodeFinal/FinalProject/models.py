...
class Categorias(models.Model):
    ...
    # Agregar una llave primaria a la tabla Categorias y después modificar el método de eliminación para que funcione con la llave primaria
    def __str__(self):
...
class Proveedores(models.Model):
    ...
    EmailProveedor = models.CharField('Email del proveedor', max_length = 100)
...
class Productos(models.Model):
    #Agregar atributo de nombre de producto aquí y en la base de datos
    ImgProducto = models.ImageField('Imágen del producto', null=True, blank=True)
    ...
    FechaUIngreso = models.CharField('Fecha de ingreso del producto', max_length = 100)
    ...
    Proveedores = models.OneToOneField(Proveedores, on_delete=models.CASCADE, default='')
    # Agregar foráneas
    
    def __str__(self):
        return self.DescripcionProducto #Poner la imágen, el nombre del producto
...
class Usuarios(models.Model):
    ImgUsuario = models.ImageField('Imágen del usuario', null=True, blank=True)
    ...
    EmailUsuario = models.CharField('Email del usuario', max_length = 100)
...
class Ventas(models.Model):
    ...
    Productos = models.ManyToManyField(Productos, default='', blank=True)
    Usuarios = models.ForeignKey(Usuarios, on_delete=models.CASCADE, default='')
    # Agregar foráneas
